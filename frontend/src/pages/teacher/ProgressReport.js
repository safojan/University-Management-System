...
import { getStudentProgressReport, getClassProgressReport, getSchoolProgressReport } from '../../redux/progressReportRelated/progressReportActions';
...
const ProgressReport = () => {
  ...
  const { report, loading, error } = useSelector(state => state.progressReport);
  ...
  useEffect(() => {
    if (reportType === 'class') {
      dispatch(getClassProgressReport(id));
    } else if (reportType === 'student') {
      dispatch(getStudentProgressReport(id));
