...
const StudentExamMarksTeacher = () => {
 ...
 const [chosenSubName, setChosenSubName] = useState("");
  ...
  useEffect(() => {
    dispatch(getStudentMarksForSubject(studentID,currentUser.teachSubject?._id));
    }, [dispatch,currentUser.teachSubject?._id,studentID]);
    ...
    const handleSubmit = (event) => {
        ...
        dispatch(updateExamResult(studentID,currentUser.teachSubject?._id,{ marks: marksList }));
    };
...
export default StudentExamMarksTeacher;
