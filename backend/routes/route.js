...
const { teacherRegister, teacherLogIn, getTeachers, getTeacherDetail, deleteTeachers, deleteTeachersByClass, deleteTeacher, updateTeacherSubject, teacherAttendance, getTeacherSubjects } = require('../controllers/teacher-controller.js');
...
router.get("/courses/:id", getTeacherSubjects)
